...
Options:
    ...
    -dryrun              run materialization without downloading files
...
def materialize(schema, headdir, limit, conditions, force, dryrun, tablename):
    ...
    if fileidsToChirp:
        ...
        database.chirp_files(fileidsToChirp, root, schema, connection, dryrun)
...
def main():
    ...
    if materializer_precheck(tablename, schema, headdir, force):
        return materialize(schema, headdir, limit, conditions, force[0], dryrun, tablename)
